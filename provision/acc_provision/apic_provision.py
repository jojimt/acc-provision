...
class ApicKubeConfig(object):
    ...
    def cluster_tn(self, flavor):
                    ...
                    (
                        ...
                        collections.OrderedDict(
                            [
                                (
                                    "attributes",
                                    collections.OrderedDict([("tnVzBrCPName", "%s-dns" % system_id)]),
                                )
                            ]
                        ),
                    )
                        ...
                        collections.OrderedDict(
                            [
                                (
                                    "attributes",
                                    collections.OrderedDict(
                                        [("tnVzBrCPName", "%s-health-check" % system_id)]
                                    ),
                                )
                            ]
                        ),
                    ...
                    (
                        ...
                        collections.OrderedDict(
                            [
                                (
                                    "attributes",
                                    collections.OrderedDict([("tnVzBrCPName", "%s-icmp" % system_id)]),
                                )
                            ]
                        ),
                    )
                                                        ...
                                                        (
                                                            ...
                                                            collections.OrderedDict(
                                                                [
                                                                    (
                                                                        "name",
                                                                        "%s-health-check-filter-in" % system_id,
                                                                    )
                                                                ]
                                                            ),
                                                        ),
                                                        ...
                                                        (
                                                            ...
                                                            collections.OrderedDict(
                                                                [
                                                                    (
                                                                        "name",
                                                                        "%s-health-check-filter-out" % system_id,
                                                                    )
                                                                ]
                                                            ),
                                                        ),
        ...
        if "dhcp_relay_label" in self.config["aci_config"]:
            ...
            for child in children:
                if "fvBD" in child:
                    if child["fvBD"]["attributes"]["name"] == ("%s-node-bd" % system_id):
                        child["fvBD"]["children"].append(attr)
                        break
